...
CREATE INDEX ix_sme_path_gist      ON submodel_element USING GIN (idshort_path gin_trgm_ops);
CREATE INDEX ix_sme_sub_path       ON submodel_element(submodel_id, idshort_path);
